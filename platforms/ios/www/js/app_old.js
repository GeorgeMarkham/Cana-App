...
function deviceReady(){
    ...
    $('#login_btn').on('click', (e)document.addEventListener('deviceready', deviceReady(), false);
    //$().ready(deviceReady());
    ...
    =>{
        ...
        $.post('http://gmarkham.com:8080/login', data, (data, status)=>{
            console.log(status);
            console.log(data);
    ...
    $('#signup_btn').on('click', (e)=>{
        ...
        $.post('http://gmarkham.com:8080/signup', data, (data, status)=>{
    ...
    $("#username_set_send_btn").on('click', (e)=>{
        ...
        $.post('http://gmarkham.com:8080/update-username', data, (data, status)=>{
            console.log(status);
            console.log(data);
